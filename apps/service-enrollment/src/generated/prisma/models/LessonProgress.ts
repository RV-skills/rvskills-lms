...
export type LessonProgressWhereInput = {
  ...
  progress_id?: Prisma.StringFilter<"LessonProgress"> | string
  enrollment_id?: Prisma.StringFilter<"LessonProgress"> | string
  lesson_id?: Prisma.StringFilter<"LessonProgress"> | string
  completed_at?: Prisma.DateTimeFilter<"LessonProgress"> | Date | string
...
export type LessonProgressWhereUniqueInput = Prisma.AtLeast<{
  progress_id?: string
  enrollment_id_lesson_id?: Prisma.LessonProgressEnrollment_idLesson_idCompoundUniqueInput
  AND?: Prisma.LessonProgressWhereInput | Prisma.LessonProgressWhereInput[]
  OR?: Prisma.LessonProgressWhereInput[]
  NOT?: Prisma.LessonProgressWhereInput | Prisma.LessonProgressWhereInput[]
  enrollment_id?: Prisma.StringFilter<"LessonProgress"> | string
  ...
  completed_at?: Prisma.DateTimeFilter<"LessonProgress"> | Date | string
  enrollment?: Prisma.XOR<Prisma.EnrollmentScalarRelationFilter, Prisma.EnrollmentWhereInput>
}, "progress_id" | "enrollment_id_lesson_id">
...
export type LessonProgressScalarWhereWithAggregatesInput = {
  ...
  progress_id?: Prisma.StringWithAggregatesFilter<"LessonProgress"> | string
  enrollment_id?: Prisma.StringWithAggregatesFilter<"LessonProgress"> | string
  lesson_id?: Prisma.StringWithAggregatesFilter<"LessonProgress"> | string
  completed_at?: Prisma.DateTimeWithAggregatesFilter<"LessonProgress"> | Date | string
}
...
export type LessonProgressCreateInput = {
  ...
  enrollment: Prisma.EnrollmentCreateNestedOneWithoutLesson_progressInput
}
...
export type LessonProgressUpdateInput = {
  ...
  enrollment?: Prisma.EnrollmentUpdateOneRequiredWithoutLesson_progressNestedInput
}
...
export type LessonProgressEnrollment_idLesson_idCompoundUniqueInput = {
  enrollment_id: string
  lesson_id: string
}
...
export type LessonProgressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"progress_id" | "enrollment_id" | "lesson_id" | "completed_at", ExtArgs["result"]["lessonProgress"]>
...
export interface LessonProgressDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const lessonProgressWithProgress_idOnly = await prisma.lessonProgress.findMany({ select: { progress_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many LessonProgresses and only return the `progress_id`
   * const lessonProgressWithProgress_idOnly = await prisma.lessonProgress.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more LessonProgresses and only return the `progress_id`
   * const lessonProgressWithProgress_idOnly = await prisma.lessonProgress.updateManyAndReturn({
   *   select: { progress_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface LessonProgressFieldRefs {
  readonly progress_id: Prisma.FieldRef<"LessonProgress", 'String'>
  readonly enrollment_id: Prisma.FieldRef<"LessonProgress", 'String'>
  readonly lesson_id: Prisma.FieldRef<"LessonProgress", 'String'>
  readonly completed_at: Prisma.FieldRef<"LessonProgress", 'DateTime'>
}
